...
addEventHandler("onClientResourceStart", resourceRoot,
    function()
        ...
        GUIEditor.window[1] = guiCreateWindow((screenW - 280) / 2, (screenH - 259) / 2, 280, 259, "Salvo Roleplay Aim Değiştirme Paneli ", false)
		...
		for k, v in ipairs(Miras) do
			addEventHandler ( "onClientGUIClick", v, function()
				...
				outputChatBox("[Yeni bir görünüm aldın!]", 0, 255, 0)
				--takePlayerMoney(2000)
			end, false)
		end

        GUIEditor.button[1] = guiCreateButton(71, 226, 127, 23, "- Uygula -", false, GUIEditor.window[1])
...
addCommandHandler("croshair", function()
