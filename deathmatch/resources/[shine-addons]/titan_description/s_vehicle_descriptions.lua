function saveToDescription(descriptions, theVehicle)
	...
	for i = 1, 5 do
		local result = dbExec(exports.mysql:getConnection(),"UPDATE vehicles SET description" .. i .. " = '" .. exports.mysql:escape_string( descriptions[i] ) .. "' WHERE id = '".. exports.mysql:escape_string(dbid) .."'")
		if result then
