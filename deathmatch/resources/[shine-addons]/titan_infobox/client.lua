...
local notificationFont = exports.titan_fonts:getFont("Roboto", 12)
...
function drawnBoxes()
    ...
    for k,v in ipairs(cache) do
        ...
        roundedRectangle(pos[1], pos[2], boxWidth, 50, tocolor(30, 30, 30, alpha[1]))
        dxDrawText(msg, pos[1] + 8 + 10, pos[2] + 26, 0, 0, tocolor(250, 250, 250, alpha[1]), 0.80, notificationFont, 'left', 'top',false,false,true,true,false)
        nowY = nowY + between
        dxDrawText(details[type][1], pos[1] + 8 + 10, pos[2] + 5, 0, 0, tocolor(250, 250, 250, alpha[2]), 0.80, notificationFontBold, 'left', 'top',false,false,true,false,false)
