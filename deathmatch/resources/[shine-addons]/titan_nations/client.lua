...
function ulkePanel()
		...
		guiGridListSetItemText(GUIEditor.gridlist[1], 0, 1, "Türkiye", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 1, 1, "Almanya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 2, 1, "Amerika", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 3, 1, "Arjantin", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 4, 1, "Arnavutluk", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 5, 1, "Avusturalya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 6, 1, "Avusturya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 7, 1, "Belcika", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 8, 1, "Brezilya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 9, 1, "Bulgaristan", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 10, 1, "Danimarka", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 11, 1, "Fransa", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 12, 1, "Guney_Afrika", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 13, 1, "Guney_Kore", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 14, 1, "Hollanda", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 15, 1, "Jamaika", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 16, 1, "Japonya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 17, 1, "Kanada", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 18, 1, "Kolombiya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 19, 1, "Kuba", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 20, 1, "Litvanya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 21, 1, "Macaristan", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 22, 1, "Makedonya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 23, 1, "Meksika", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 24, 1, "Misir", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 25, 1, "Nijerya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 26, 1, "Norvec", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 27, 1, "Peru", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 28, 1, "Polonya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 29, 1, "Portekiz", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 30, 1, "Romanya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 31, 1, "Rusya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 32, 1, "Slovakya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 33, 1, "Sirbistan", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 34, 1, "Ukrayna", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 35, 1, "Vietnam", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 36, 1, "Yeni_Zellanda", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 37, 1, "Yunanistan", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 38, 1, "Cin", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 39, 1, "Ingiltere", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 40, 1, "Irlanda", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 41, 1, "Iskocya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 42, 1, "Ispanya", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 43, 1, "Israil", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 44, 1, "Isvec", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 45, 1, "Isvicre", false, false)
        guiGridListSetItemText(GUIEditor.gridlist[1], 46, 1, "Italya", false, false)  
				showCursor(true)  
...
-------------------------------------------------------------------------------
				if source and myItemData then
						...
						if myItemData == "Türkiye" then
							triggerServerEvent("turkiye",getLocalPlayer(),getLocalPlayer())
							showCursor(false)
							destroyElement(pencere)
						end
				end
