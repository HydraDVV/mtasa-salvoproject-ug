function sehireGondert(thePlayer, cmd, targetPlayer)
      ...
      if not targetPlayer then
         ...
         setElementPosition(targetPlayer, 257.7578125, 2889.2119140625, 11.498973846436)
     ...
     --    outputChatBox("#63a6e2[+]"..targetPlayerName.." Adlı Oyuncuyu Grotti Gönderen Admin : "..getPlayerName(thePlayer), getRootElement() ,0, 255, 0, true)
         outputChatBox("[!] #ffff00"..targetPlayerName.." #ffffff isimli oyuncuyu başarıyla balikci gönderdiniz.", thePlayer, 0, 255, 0, true)
                 end
	 end
end
addCommandHandler("balikci", sehireGondert)
