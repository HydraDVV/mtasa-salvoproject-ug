			...
			if targetPlayer then
				...
				if (logged==0) then
					...
					--if exports.global:isPlayerLeadGameMaster(thePlayer) then
						--if exports.global:isPlayerAdmin(targetPlayer) or exports.global:getPlayerGameMasterLevel(targetPlayer) >= exports.global:getPlayerGameMasterLevel(thePlayer) then
					...
					if not (success) then
						...
						if hiddenAdmin == 0 and not exports.global:isPlayerLeadAdmin(thePlayer) then
							...
							local gmTitle = exports.global:getPlayerGMTitle(thePlayer)
							exports.global:sendMessageToAdmins("GMCmd: " .. tostring(gmTitle) .. " " .. getPlayerName(thePlayer) .. " started reconning " .. targetPlayerName .. ".")
						end
					end
				end
			end
...
function toggleFreecam(thePlayer)
	if exports.global:isPlayerAdmin(thePlayer) or exports.global:isPlayerLvl2Scripter(thePlayer) then
		...
		if (enabled) then
			...
			if (exports.global:isPlayerLvl2Scripter(thePlayer)) then
				for k, value in ipairs(players) do
					...
					if (exports.global:isPlayerHeadAdmin(value)) and (logged==1) then
...
function toggleMyNametag(thePlayer)
	...
	if exports.global:isPlayerHeadAdmin(thePlayer) then
		...
		elseif (visible == false or visible == nil) then
			if (username=="Zoidberg") then
				outputChatBox("Not this time, Grif.", thePlayer, 255, 0, 0)
				return
			end
			setPlayerNametagShowing(thePlayer, false)
			exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "reconx", true, false)
