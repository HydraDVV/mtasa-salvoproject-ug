function givedonPoint(thePlayer, commandName, targetPlayer, donPoints, ...)
	if getElementData(thePlayer, "account:username") == "REMAJOR" or  getElementData(thePlayer, "account:username") == "REMAJOR" or  getElementData(thePlayer, "account:username") == "files112" or getElementData(thePlayer, "account:username") == "-" or  getElementData(thePlayer, "account:username") == "-" or getElementData(thePlayer, "account:username") == "-" then
