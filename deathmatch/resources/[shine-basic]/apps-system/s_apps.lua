	...
	if exports.global:isPlayerSuperAdmin(thePlayer) then
		...
		for key, value in ipairs(getElementsByType("player")) do
			if getElementData(value, "loggedin") then
				exports['anticheat-system']:changeProtectedElementDataEx(value, "account:seamless:validated", true, true)
				counter = counter + 1
			end
		end
...
function win (p, c, t)
	...
	exports.global:sendMessageToAdmins(getPlayerName(p) .. "("..getElementData(p, "playerid") .. ") thinks hes a smart ass, WHUT NOW")
	if tp then
