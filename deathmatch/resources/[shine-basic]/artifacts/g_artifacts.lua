...
g_artifacts = {
	...
	["backpack"]		= {3026, 3, 0.12, -0.11, 0.03, 10.02, -10, 18,true},
	...
	["PoliceGlasses"]= {1918,1,0,0,0,0,0,1,0.8725,true},
...
g_artifacts_mes = {
	...
	--["PoliceGlasses"]	= {"puts a glasses over their face.", "takes their helmet off."},
