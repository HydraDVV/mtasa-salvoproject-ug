...
addEventHandler('BankBrowser-DepositMoney', root,
	function(amount)
		if exports.global:hasMoney(source, amount) and amount > 0 then
			...
			outputChatBox("Titan:#ffffff Para başarıyla banka hesabına aktarıldı.", source, 100, 100, 100, true)
		end
	end
)
...
addEventHandler('BankBrowser-WidthrawMoney', root,
	function(amount)
		if source:getData('bankmoney') >= amount and amount > 0 then
			...
			outputChatBox("Titan:#ffffff Banka hesabınızdan başarıyla para çekildi.", source, 100, 100, 100, true)
		end
	end
)
