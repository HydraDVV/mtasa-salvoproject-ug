...
function GMHelp (commands, scriptUpdates)
	...
	myGMWindow = guiCreateWindow ( 0.15, 0.15, 0.7, 0.7,  "Index of GM commands | Dynamic Commands Library by Maxime - UG", true)
	...
	if not exports.global:isPlayerHeadAdmin(getLocalPlayer()) and not exports.global:isPlayerHeadGameMaster(getLocalPlayer()) and not getElementData(getLocalPlayer(), "hasCmdLibraryAccess") then
	...
	if exports.global:isPlayerHeadAdmin(getLocalPlayer()) or exports.global:isPlayerHeadGameMaster(getLocalPlayer()) or getElementData(getLocalPlayer(), "hasCmdLibraryAccess") then
...
function copyToClipboard1GM(button,state)
	...
	if (row==-1) or (col==-1) then
		...
		elseif (exports.global:isPlayerHeadAdmin(getLocalPlayer()) or exports.global:isPlayerHeadGameMaster(getLocalPlayer()) or getElementData(getLocalPlayer(), "hasCmdLibraryAccess")) and (button == "right") and (state == "up") then
