...
function hasPlayerPerk(targetPlayer, perkID)
	--outputDebugString(targetPlayer)
	--outputDebugString(perkID)
	...
	if string.len(code) == 40 then
		...
		if result then
			if packages[itemNumber] then
				...
				elseif itemNumber == 23 then
					outputChatBox("Fuck you. Here, take this freaking pot, nigger11!!!11112312111!", source, 0, 255, 0)
				else
					outputChatBox("You have successfully redeemed your donation package!", source, 0, 255, 0)
				end
