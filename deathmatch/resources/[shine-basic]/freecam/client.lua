...
function toggleFreecam(cmd)
	if not isEnabled(localPlayer) and cmd == "freecam" then
		if getElementData(localPlayer, "loggedin") == 1 and exports.global:isPlayerTrialAdmin(localPlayer) or exports.global:isPlayerScripter(localPlayer) or getElementData(localPlayer, "canFly") then
