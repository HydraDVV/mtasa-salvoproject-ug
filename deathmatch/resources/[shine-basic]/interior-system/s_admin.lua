...
function setInteriorPrice( thePlayer, commandName, cost )
	if exports.global:isPlayerHeadAdmin( thePlayer ) or exports.donators:hasPlayerPerk(thePlayer, 14) then
		cost = tonumber( cost )
		if not cost then
...
function updateInteriorEntrance(thePlayer, commandName, intID)
	if getElementData(thePlayer, "account:username") == "Reifen" or getElementData(thePlayer, "account:username") == "FatihKinq" or getElementData(thePlayer, "account:username") == "dorimez" or getElementData(thePlayer, "account:username") == "woh3x" or getElementData(thePlayer, "account:username") == "- " or getElementData(thePlayer, "account:username") == "Darkness" then
