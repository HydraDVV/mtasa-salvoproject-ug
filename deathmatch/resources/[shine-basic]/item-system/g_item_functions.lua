...
function getItemName(id, value)
	...
	elseif id == 150 and value and value:find(";") ~= nil then -- ATM Card
		return g_items[id][1].." (Card Number: "..value:sub( value:find( ";" ) + 1 )..")", "Owner: "..tostring(value:sub(1, (value:find( ";" )-1))):gsub("_", " ")..""
	else
		return g_items[id][1]
	end
end
...
function getItemValue(id, value)
	...
	elseif (id == 150) and value and value:find( ";" ) ~= nil then
		return value:sub( value:find( ";" ) + 1 )
	elseif (id == 115 and value) then
...
function explode(div,str) -- credit: http://Salvo.warburton.it
