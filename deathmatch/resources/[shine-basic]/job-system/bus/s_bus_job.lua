...
function takeBusFare(thePlayer)
	exports.global:takeMoney(source, 1000)
...
function otobusBitir(thePlayer)
	...
	setElementPosition(thePlayer, 1807.4462890625, -1898.84765625, 13.580009460449)
	setElementRotation(thePlayer, 0, 0, 88.542907714844)
end
