...
function serviceVehicle(veh)
	if (veh) then
		...
		if not exports.global:takeMoney(source, mechcost) then
			...
			exports.global:sendLocalMeAction(source, "aracınız servis tarafından ilk müdahale yapıldı.")
...
function changeTyre( veh, wheelNumber )
	if (veh) then
		...
		if not exports.global:takeMoney(source, mechcost) then
			...
			exports.global:sendLocalMeAction(source, "tekerin patlak alanlarını kapatır ve tekrardan takarak tamir eder.")
		end
	end
end
	...
	if (veh) then
		...
		if not exports.global:takeMoney(source, mechcost) then
			...
			if setVehiclePaintjob( veh, paintjob ) then
				...
				exports.global:sendLocalMeAction(source, "araba yeniden boyandı")
	...
	if (veh) then
		...
		if not exports.global:takeMoney(source, mechcost) then
			...
			if setVehicleHeadLightColor ( veh, color1, color2, color3) then
				...
				exports.global:sendLocalMeAction(source, "farlar üzerindeki ledleri değiştiri ve tekrar takar.")
	...
	if (veh) then
		...
		if not exports.global:takeMoney(source, mechcost) then
			...
			if setVehicleColor( veh, color1[1], color1[2], color1[3], color2[1], color2[2], color2[3],  color3[1], color3[2], color3[3], color4[1], color4[2], color4[3]) then
				...
				exports.logs:dbLog(source, 6, veh, "MECHANIC_COLOR")
				exports["vehicle-manager"]:addVehicleLogs(getElementData(veh, "dbid"), "MECHANIC_COLOR", source)
				exports.global:sendLocalMeAction(source, "arabanın rengi tekrar boyandı")
				exports['savevehicle-system']:saveVehicleMods(veh)
