...
function useWaterCooler(thePlayer)
	if not thePlayer then thePlayer = source end
	exports.global:sendLocalMeAction(thePlayer, "takes a cup from the water cooler and fills it with water.")
	exports.global:giveItem(thePlayer, 15, 1)
end
addEvent("object-interaction:getWater", true)
addEventHandler("object-interaction:getWater", getRootElement(), useWaterCooler)