...
function toggleCarshop(Data)
	...
	vehElement = exports["object-preview"]:createObjectPreview(vehObject, 0, 0, 410, 0.854, 0.517, 0.14, 0.10, true, false)	
	exports["object-preview"]:setRotation(vehElement,0, 0, 155 + 0 * 360)
	...
	addEventHandler("onClientGUIClick", guiRoot, 
		...
		if isElement(vehObject) then
			...
			if vehElement then
				exports["object-preview"]:destroyObjectPreview(vehElement)
			end	
		end		
	end
end
