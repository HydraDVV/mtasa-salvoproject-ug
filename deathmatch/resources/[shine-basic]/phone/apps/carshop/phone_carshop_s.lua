...
function phoneBuyVeh(vehid, brandid, rgb, balance, vehname, plateState, plateEditText)
	...
	if tonumber(vehid) and tonumber(brandid) then
		if exports.global:takeMoney(player, balance) then
			...
			local var1, var2 = exports['vehicle-system']:getRandomVariant(vehid)
			...
			outputChatBox("#575757Salvo:#f9f9f9 Bu aracı sipariş verebilmen için yeterli paran yok.", player, 255, 0, 0, true)
		end
	end
end
