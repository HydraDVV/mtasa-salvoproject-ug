	...
	dbQuery(
		function(qh, source)
			local res, rows, err = dbPoll(qh, 0)
				...
				exports['anticheat-system']:changeProtectedElementDataEx(source, "callingContact", contact, false)
					...
					if not foundInGame then
						...
						exports['anticheat-system']:changeProtectedElementDataEx(source, "call.col", publicphone, false)
						exports['anticheat-system']:changeProtectedElementDataEx(source, "calling", tonumber(contact.entryNumber), false)
						exports['anticheat-system']:changeProtectedElementDataEx(targetPlayer, "calling", tonumber(from), false)
						exports['anticheat-system']:changeProtectedElementDataEx(targetPlayer, "callingwith", tonumber(contact.entryNumber), false)
						exports['anticheat-system']:changeProtectedElementDataEx(source, "called", false, false)
						exports['anticheat-system']:changeProtectedElementDataEx(targetPlayer, "called", true, false)
						exports['anticheat-system']:changeProtectedElementDataEx(source, "phonestate", 2, false)
						exports['anticheat-system']:changeProtectedElementDataEx(targetPlayer, "phonestate", 3, false)
...
function makeCall(thePlayer)
	outputChatBox("#575757Salvo:#f9f9f9 Telefon görüşmesi gerçekleştirebilmek için telefonu açmalısın.",thePlayer, 255, 0, 0, true)
end
...
function acceptPhoneCall()
	...
	if caller then
		...
		exports['anticheat-system']:changeProtectedElementDataEx(caller, "phonestate", 4, false)
		exports['anticheat-system']:changeProtectedElementDataEx(source, "phonestate", 5, false)
...
function takeCallCost(cost, fromNumber, duration)
	if cost > 0 then
		if exports["bank-system"]:takeBankMoney(source, cost) then
			...
			if exports.global:giveMoney(foundFaction, cost) then
				return exports["bank-system"]:addBankTransactionLog(getElementData(source, "dbid"), -20, cost, 2, "Cellphone's phone call fee", "Call made from #"..fromNumber..", duration: "..duration, nil, nil)
			end
		end
	end
	return false
		...
		if (exports.global:hasItem(thePlayer, 2)) or getElementData(thePlayer, "call.col") then -- 2 = Cell phone item
			...
			if phonestate == 4 or phonestate == 5 then
				...
				if (not loudspeaker) then
					...
					exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "call.loudspeaker", true, false)
				else
					...
					exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "call.loudspeaker", false, false)
				end
			end
		end
	end
		...
		if (exports.global:hasItem(thePlayer, 2)) or getElementData(thePlayer, "call.col") then
			...
			elseif getElementData(thePlayer, "injuriedanimation")  then
				...
				if (phoneState == 4 or phoneState == 5) then 
					...
					local message2 = message--call(getResourceFromName("language-system"), "applyLanguage", thePlayer, target, call( getResourceFromName( "chat-system" ), "trunklateText", target, message ), language)
...
function resetPhoneState(thePlayer)
	exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "callingwith", nil, false)
	...
	exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "phonestate", nil, false)
	exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "calltimer", nil, false)
	exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "callingContact", nil, false)
	...
	exports['anticheat-system']:changeProtectedElementDataEx(thePlayer, "call.loudspeaker", false)
