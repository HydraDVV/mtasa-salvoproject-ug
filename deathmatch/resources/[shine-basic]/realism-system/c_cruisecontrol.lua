...
function cruiseControl()
	...
	if theVehicle and driver then
		...
		if (speed > 5) then
			if (getVehicleType(theVehicle) == "Automobile" or getVehicleType(theVehicle) =="Boat" or getVehicleType(theVehicle) =="Monster Truck" or getVehicleType(theVehicle) == "Train") then
			if (ccEnabled) then
