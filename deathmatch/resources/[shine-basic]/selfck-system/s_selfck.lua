...
function sendCKRequest(target, text)
	...
	outputChatBox("#FF0000[!]#FFFFFFİsteğiniz yönetcilere gönderildi, beklemeye geçiniz.", target, 0, 0, 0, true)
	outputChatBox("#FFFFFF[!]#FFFFFFİsteğinizi iptal etmek istiyorsanız, /cancelck kullanın..", target, 0, 0, 0, true)
			...
			if piss=="requested" then
				if (logged==0) then
					...
					if (actualCharID == charID) then
						...
						triggerClientEvent(targetPlayer, "account:characters:show", targetPlayer)
					else
