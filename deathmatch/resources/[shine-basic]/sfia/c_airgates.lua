local allowedFactions = {
	[15]=true,	--Los Santos International Airport
}
...
function canPlayerControlGates()
	...
	if(allowedFactions[faction] or exports.global:isPlayerFullAdmin(thePlayer) and getElementData(thePlayer, "adminduty") == 1) then
		return true
	end
