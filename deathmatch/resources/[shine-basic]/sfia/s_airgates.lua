...
function setTempCallsign(thePlayer, commandName, vehID, ...)
	...
	if(tonumber(realFactionID) == LSIAfactionID and tonumber(factionLeaderStatus) == 1 or exports.global:isPlayerSuperAdmin(thePlayer) and getElementData(thePlayer, "adminduty") == 1) then
