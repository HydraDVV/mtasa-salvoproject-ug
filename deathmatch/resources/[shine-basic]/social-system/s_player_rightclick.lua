...
function restrainPlayer(player, restrainedObj)
	...
	outputChatBox("[!]Bu kişi tarafından kelepçelendin. İsim :  " .. username .. ".", player, 255, 170, 0)
	outputChatBox("[!]Şu kişiyi kelepçeledin. İsim : " .. targetPlayerName .. ".", source, 255, 170, 0)
...
function unrestrainPlayer(player, restrainedObj)
	...
	outputChatBox("[!]Şu kişi tarafından kelepçen çıkartıldı. İsim :  " .. username .. ".", player, 255, 170, 0)
	outputChatBox("[!]Şu kişinin kelepçesini çıkarttın. İsim : " .. targetPlayerName .. ".", source, 255, 170, 0)
