...
--[[function setHandling()
  ...
  -- Commented out by Chuevo. Do not uncomment.
   ...
   if (getElementData(veh, "dbid") == 3096) then -- DO NOT REMOVE THIS. - Chuevo
	...
	if (getElementData(veh, "dbid") == 1776) then
	 setVehicleHandling(veh, "maxVelocity", 180)
	 setVehicleHandling(veh, "brakeDeceleration", 1000)
	 setVehicleHandling(veh, "tractionMultiplier", 0.8)
	 setVehicleHandling(veh, "engineAcceleration", 18)
	end
	if (getElementData(veh, "dbid") == 2973) then
	 setVehicleHandling(veh, "maxVelocity", 999)
	 setVehicleHandling(veh, "brakeDeceleration", 1000)
	 setVehicleHandling(veh, "tractionMultiplier", 0.8)
	 setVehicleHandling(veh, "engineAcceleration", 80)
	end
	if (getElementData(veh, "dbid") == 3322) then  
		setVehicleHandling(veh, "engineAcceleration", 15) 
		setVehicleHandling(veh, "maxVelocity", 180) 
		setVehicleHandling(veh, "brakeDeceleration", 1000) 
		setVehicleHandling(veh, "tractionMultiplier", 0.8) 
	end
	if (getElementData(veh, "dbid") == 3434) then  
		setVehicleHandling(veh, "engineAcceleration", 30) 
		setVehicleHandling(veh, "maxVelocity", 260) 
		setVehicleHandling(veh, "brakeDeceleration", 8) 
		setVehicleHandling(veh, "tractionMultiplier", 13) 
		setVehicleHandling(veh, "steeringLock", 10)
	end
  end
end
