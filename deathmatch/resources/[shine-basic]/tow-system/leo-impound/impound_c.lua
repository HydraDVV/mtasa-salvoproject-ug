...
--SERVICE PED
local pdImpounder = createPed( 281, 8.474609375, -5.2333984375, 40.42191696167 )
setPedRotation( pdImpounder, 268.50170898438 )
setElementDimension( pdImpounder, 89)
setElementInterior( pdImpounder , 24)
...
local hpImpounder = createPed( 288, 2807.4248046875, -1426.896484375, 16.255474090576 )
setPedRotation( hpImpounder, 181.91 )
...
local pdReleasePed = createPed(280, 8.4775390625, -3.8798828125, 40.4296875 )
setPedRotation( pdReleasePed, 271 )
setElementDimension( pdReleasePed, 89)
setElementInterior( pdReleasePed , 24 )
...
local hpReleasePed = createPed( 288, 7.0947265625, -0.896484375, 40.4296875 )
setPedRotation( hpReleasePed, 0.66 )
setElementDimension( hpReleasePed, 89)
setElementInterior( hpReleasePed , 24 )
