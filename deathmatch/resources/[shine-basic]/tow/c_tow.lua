...
local ped = createPed(240, 8.4697265625, -2.44140625, 40.4296875)
setElementInterior(ped, 24)
setElementDimension(ped, 89)
setElementRotation(ped, 0, 0, 267.46, "default", true)
...
function showImpoundUI(vehElementsret)
	if not wImpound then
		...
		outputChatBox("#ffffff[#55C315!#ffffff] LS&CT #ffffffbinasına hoş #55C315geldiniz..",255,255,0,true)
	end
end
