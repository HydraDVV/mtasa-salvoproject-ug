function VehicleFixes()
	...
	setModelHandling(503, "mass", 2500)
	setModelHandling(503, "turnMass", 5700)
	setModelHandling(503, "dragCoeff", 2.5)
	setModelHandling(503, "centerOfMass", {0.0, 0.0, -0.3} )
	setModelHandling(503, "percentSubmerged", 80)
	setModelHandling(503, "tractionMultiplier", 0.65)
	setModelHandling(503, "tractionLoss", 0.89)
	setModelHandling(503, "tractionBias", 0.5)
	setModelHandling(503, "numberOfGears", 5)
	setModelHandling(503, "maxVelocity", 260)
	setModelHandling(503, "engineAcceleration", 10)
	setModelHandling(503, "engineInertia", 25)
	setModelHandling(503, "driveType", "awd")
	setModelHandling(503, "engineType", "petrol")
	setModelHandling(503, "brakeDeceleration", 7)
	setModelHandling(503, "brakeBias", 0.45)
	setModelHandling(503, "ABS", true)
	setModelHandling(503, "steeringLock", 35)
	setModelHandling(503, "suspensionForceLevel", 1)
	setModelHandling(503, "suspensionDamping", 0.05)
	setModelHandling(503, "suspensionHighSpeedDamping", 0.0)
	setModelHandling(503, "suspensionUpperLimit", 0.40)
	setModelHandling(503, "suspensionLowerLimit", -0.2)
	setModelHandling(503, "suspensionFrontRearBias", 0.5)
	setModelHandling(503, "suspensionAntiDiveMultiplier", 0.3)
	setModelHandling(503, "seatOffsetDistance", 0.44)
	setModelHandling(503, "collisionDamageMultiplier", 0.35)
	setModelHandling(503, "modelFlags", 0x20)
	setModelHandling(503, "handlingFlags", 0x304407)
	setModelHandling(503, "headLight", 1)
	setModelHandling(503, "tailLight", 1)
	setModelHandling(503, "animGroup", 0)	
