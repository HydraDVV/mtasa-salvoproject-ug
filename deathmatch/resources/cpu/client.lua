...
local resStat = false
local hfont1 = exports.titan_fonts:getFont("RobotoB",9)
local hfont = exports.titan_fonts:getFont("Roboto",9)
...
function resStatRender()
	...
	if #serverRows == 0 then
		dxDrawText("Client",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1,hfont1,"center")
	else
		dxDrawText("Client",sx-235,y-20,sx-235,y-20,tocolor(255,255,255,255),1,hfont1,"center")
	end
	dxDrawRectangle(x-10,y,150,height,tocolor(0,0,0,240))
	y = y + 5
	for i, row in ipairs(rows) do
		local text = row[1]:sub(0,15)..": "..row[2]
		dxDrawText(text,x+1,y+1,150,15,tocolor(0,0,0,255),1,hfont)
		dxDrawText(text,x,y,150,15,tocolor(255,255,255,255),1,hfont)
		y = y + 15
	end
	...
	if #serverRows ~= 0 then
		...
		local y = sy/2-height/2
		dxDrawText("Server",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1,hfont1,"center")
		dxDrawRectangle(x-10,y,150,height+15,tocolor(0,0,0,240))
		y = y + 5
